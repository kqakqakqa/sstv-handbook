...
redundancy is generated from some input data on a transmission side *(FEC &ndash; Forward Error Correction)* and on a reception side it is possible to
...
symbols. RS code have found application in the number of areas &ndash; is used by
...
Parameters of the RS(*n*,&thinsp;*k*) are defined as follows:

- *k* &ndash; number of s-bit symbols in data block,

- *n* &ndash; number of bits in codeword.

RS(*n*,&thinsp;*k*) is able to correct $$ errors in *k* information
symbols. Often used code is RS(255,&thinsp;223), it uses 223 8-bit symbols for
creation of 255 symbols of codeword. There is 32 symbols dedicated for error
correction. RS(255,&thinsp;223) is able to repair up to 16 erroneous 8-bit symbols.
