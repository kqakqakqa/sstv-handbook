...
We have two choices for digital image transmission. The first system is *RDFT &ndash; Redundant Data File Transfer*, which is the result of several years of
creative efforts of Barry Sanderson, KB9VAK and a group of ham radio
enthusiasts.

The second system is called *Digital Radio Mondiale (DRM)*. It's open
...
for ham radio purposes is called *HamDRM*.

It is possible to use these modes also for transfer of any types of files
(text, sounds, software,) instead of images.
...
classic SSTV. You need better computer, at least 1GHz CPU and 256&thinsp;MB RAM. In
your ham-shack you can use without any problems an oldish computer (e.g.
Pentium 150&thinsp;MHz) for digital modes like RTTY or PSK, packet radio and analog
SSTV, but algorithms of signal processing for DSSTV is so complex that a slow
150&thinsp;MHz Pentium would not be able to process signals in real-time.
...
filters (speech processor, equalizer,).
...
$^1\!/\!<sub>3</sub>$ of maximum (switch off software AGC). When signal is overexcited,
...
is about 20&ndash;25&thinsp;W.

[](9.1_digital-communication-basics.md ":include")

[](9.2_error-detection-and-correction.md ":include")

[](9.3_data-compression.md ":include")
