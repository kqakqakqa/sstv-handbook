...
broadcasting (*Fast-Scan Television*). An analog FSTV
...
However, the issue of this book is *image transmission on
short waves*.

The most popular narrow-band mode for image transmission is
SSTV &ndash; *Slow-scan Television*. Unlike the classic TV it can
...
Another option for shortwave image transmission is
...
<div style="display: flex; justify-content: space-between; margin-top: 4rem;">
  <span>In Žďář nad Sázavou, {{GIT_DATE}}</span>
  <span>Martin OK2MNM</span>
</div>