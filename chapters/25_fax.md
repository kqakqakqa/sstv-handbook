...
Facsimile (from latin *facere* – make and *simile* – similar) is one
...
The frequency modulation *F3C* is used for shortwave transmission ($F$ – frequency modulation,
$3$ – single channel containing analog information, $C$ – facsimile). The transmitter modulates
the frequency of carrier in the range $$400\,Hz on shortwaves and $$150\,Hz on
...
Most commercial stations use *APT – Automatic Picture Transmission* for a
...
The most important parameters of the transmission are the speed and *index of cooperation – IOC*. The IOC relates with a horizontal scan rate and
...
Figure 6: Typical synoptic map transmitted on HF by facsimile, here from station DDH3, line speed 120\,lpm and IOC 576.
...
{ Name IOC lpm APT start d APT stop d Note Wefax 288 288 120\,/\,90\,/\,60 675 Hz 3 s 450 Hz 3 s Wefax 576 576 120\,/\,90\,/\,60 300 Hz 3 s 450 Hz 3 s Ham Color 204 360 200 Hz 5 s 450 Hz 5 s color Ham 288b 240 240\,/\,120 675 Hz 5 s 450 Hz 5 s Color 240 288 240 200 Hz 3 s 450 Hz 5 s color FAX 480 204 480 500 Hz 3 s 450 Hz 3 s Photopress 352 60 ? ? 450 Hz ? $d$ – minimal duration of APT signal }
