...
*Slow-scan television (SSTV)* is a mode of communication
...
"Cop" Macdonalds (*1936 &ndash; †2011), WA2BCW (later
...
20<sup>th</sup> of December 1959.

<div class="figure-combo">

  <div class="figure-item">
    <div class="figure-wrapper" style="height: 18rem;">
      <img src="res/sstv/obrazek1.png" />
    </div>
    <div>The first image that crossed the Atlantic, received by John Plowman G3AST.</div>
  </div>

  <div class="figure-item">
    <div class="figure-wrapper" style="height: 18rem;">
      <img src="res/sstv/copthorn.png" />
    </div>
    <div>Copthorne Macdonald's broadcast.</div>
  </div>

  <div><b>Figure 2.1:</b> Early slow-scan television images.</div>
...
that a typical 3&thinsp;MHz signal of black and white television must be
reduced to 3&thinsp;kHz &ndash; the reduction of bandwidth is around
1000&thinsp;:&thinsp;1. Nowadays the bandwidth reduction is bigger because
the color image needs approx. 6&thinsp;MHz. Therefore, only static
...
visible, but in a while &ndash; the image slowly disappears. For the
...
line synchronization pulses by electronic circuits is 5&thinsp;ms and
for image (vertical) synchronization it is 30&thinsp;ms. Vertical
...
50&thinsp;Hz divided by three &ndash; 16.6&thinsp;Hz is used. And for vertical
scan 1/7.2&thinsp;=&thinsp;0.1388&thinsp;Hz is used, this is the mains
frequency divided by 360 (3&thinsp;×&thinsp;number of lines 120). The
parameters are derived in the same way for countries with 60&thinsp;Hz
mains.

The video signal band was chosen in the range from 1500&thinsp;Hz for
black up to 2300&thinsp;Hz for white. Sync pulses have a frequency of
1200&thinsp;Hz and because they are "blacker than black" then they
