...
companies – the American *Robot Research Inc.* and the
...
majority of them are unique and incompatible
...
1900\,Hz – *sub-carrier*. This modulation method is called
...
Figure 1: The SSTV frequency spectre for two various images transferred in Martin\,M1 mode.

[Image: sstv/obr/sstv_spectrum.pdf]

The emission classification code for the SSTV mode is *J3F*, which means:

- *3* – Nature of modulating signal: One channel containing analog information.
...
Figure 2: Image quality depends on resolution.

[Image: sstv/obr/ara50x38]

[Image: sstv/obr/ara120x90.png]

*Resolution* is a feature that tells what amount of details is
possible to store in an image, see . The
resolution has two parameters: *horizontal resolution* – the number
of image columns $$ number of image lines – *the vertical resolution*.
...
that the number of columns is $2404/3=320$. This value
then corresponds to a theoretical resolution, but not a *real* image resolution.

The test chart () is used to qualify
...
image with normal photography in .

Figure 3: Horizontal resolution comparison for several SSTV modes.

[Image: sstv/obr/resol/original.png]

All SSTV modes in have 320 columns.
...
picture in . The last two modes listed have
...
Figure 4: The comparison of two modes in real conditions of 14\,MHz band.

[Image: sstv/obr/rozliseni_m1.png]
