...
Northern Asia) there are recommended frequencies .

{ Frequency Recommendation 3735&thinsp;kHz center of activity 7165&thinsp;kHz center of activity (previously 7030 &ndash; 7040&thinsp;kHz) 14230&thinsp;kHz center of activity 21340&thinsp;kHz center of activity 28680&thinsp;kHz center of activity 144500&thinsp;kHz calling frequency for SSTV 432500&thinsp;kHz narrowband SSTV 433400&thinsp;kHz SSTV (FM/AFSK) }

The usage of side band is same like for voice operations,
on bands below 10&thinsp;MHz it is LSB and for above bands it is USB.
...
frequency: "Is this frequency free for SSTV?" and again listen if the
frequency is really free. There is unpleasant feature of some bands, e.&thinsp;g. 20
meters (14&thinsp;MHz), that closer stations we can't detect, although only a noise
...
to each other around 14230&thinsp;kHz, they are interfering each other
...
frequency at least $3$&thinsp;kHz. Good practice is chose frequency near
centra of activity in 3kHz steps, e.g. on 15 meters:

21334 21337 21340 21343 21346
...
(Change to transmission on another frequency [(or on ${ }$&thinsp;kHz]) and specify frequency where you can continue the QSO.
...
signs, e.&thinsp;g. { OK1AAA de OK2BBB} and report RSV into your picture. The
...
Figure 1: Sample received SSTV images for your inspiration.

[Image: ostatni/obr/prijate_obrazky.jpg]
...
The message about report contains info about &ndash; readability, signal
...
&ndash; shows quality of signal reception in 5 degrees.

&ndash; describes strength of received signal in 9 degrees.
...
&ndash; the quality of received image you can consider visually
in 5 degrees, see . The same method is used in ATV picture
quality reporting system.

{ R &ndash; Readability S &ndash; Sig. strength V &ndash; Video 1 Unreadable Faint signal, barely perceptible Barely perceptible 2 Barely readable, occasional words distinguishable Very weak Poor 3 Readable with considerable difficulty Weak Fair 4 Readable with practically no difficulty Fair Good 5 Perfectly readable Fairly good Excellent 6 Good 7 Moderately strong 8 Strong 9 Very strong signals }

The report can expand information on interference (QRM, QRN) or if the image is
slanted add entry { SLANT}. The example report is { RSV 595} when the
reception is awesome.

Figure 2: Picture quality reporting system.

[Image: ostatni/obr/p1.png]

## SSTV not only for hams
...
active Volcano . U.S. Geological Survey installed in
September 1987 sensing camera and FM radio transceiver for observation
of volcanic activity on Mount St. Helena.

SSTV was used for remote medical applications during eighties, e.&thinsp;g.
...
different, but their engineers also named it *slow-scan TV*, but
...
### IVCA DX Achievement Award DXAA
...
Award manager: *S.K.Mogensen OZ6SM, Rundhøjvej 8, DK 7970 Redsted, Danmark*, email: `oz6sm@nypost.dk`.
...
1^st March 1998. Contacts with members of the Moscow SSTV is valuated by
3 points and one point for contacts with CIS countries or stations not members of the Moscow SSTV 1.

Send GCR list and fee of $5, 10 IRC or equivalent to: *Verigin Dmitriy Andreevich, Lyubertsy, Moscovskaya oblast, Novaya street, 10-48, 140002, Russia*,
email: `ra3ahq@online.ru`

## Contests

### DARC SSTV Contest

It takes place the 3^rd weekend in March, begins at 12:00 UTC on Saturday
and ends at 12:00 UTC on Sunday. Competing has categories operator and
SWL, on the bands 3.5 to 28&thinsp;MHz. Transmit RSV and the number of QSOs
...
after the contest at: *Werner Ludwig DF5BX, Post Box 1270, D-49110 Georgsmarienshuette, Germany*, email: `df5bx@darc.de`.

### Russian SSTV Contest

Takes place in 2^nd Saturday in April from 00:00 MSK to 24:00 MSK
(UTC&thinsp;=&thinsp;MSK&thinsp;&ndash;&thinsp;3). Bands: 80, 40, 20, 15, 10, 6, 2&thinsp;m. There are several
...
CQ image should contains { CQ RUSTEST}. Transmit RSV and the number of QSOs
...
24^th April. Organizer: *Russian SSTV Contest Manager Krenkel of CRC Russia, P.O. Box 88, Moscow, Russia*.
...
used "M" letter in report, e.&thinsp;g. 595M), and 1 point for another QSO. Only
one QSO with same station is counted regardless of band. The multiplier is the
total number of different prefixes. Send log to *Susumu Tokuyasu JA6GN, 3-1-6 Jyousei Sawaraku, Fukuoka 814-0003, Japan* or email: `sstv-contest-nvcg@wak.bbiq.jp`.
...
80, 40, 20, 15, 10, 6, 2&thinsp;m. Score: 2 points for every DXCC country, 1
...
stations on 1^st to 5^th place will receive certificates.
Mail logs to: *Carl Emkjer, Soborghus Park 8, DK 2860 Soborg, Denmark*.

### JASTA SSTV Activity

Takes place in August from 1^st 00:00 UTC to 31^st 24:00
UTC on 3.5&thinsp;MHz band and all upper bands. There are two categories:
"J"
...
UTC day. The points for QSOs depend on band: 1 point 3.5&ndash;28&thinsp;MHz, 2
points 50&ndash;430&thinsp;MHz and 3 point for 1200&thinsp;MHz and upper bands.
...
*Yoshikazu Tanabe JA3WZT/1, 905-8, Shimotaniganuki, IRUMA, SAITAMA, 358 Japan*, send logs in TXT format to `ja3wzt@mue.biglobe.ne.jp`.

### Ukrainian SSTV Contest

Takes place in first Saturday in December, from 12:00 UTC to Sunday
12:00 UTC. Bands: 80, 40, 20, 15 and 10&thinsp;m. There are contest
categories: A. One operator; B. One operator, one band; C. Multiple
operators; F. listeners. The CQ picture should contain text { CQ UKR Contest}. Exchange report RSV and number from 001. Ukrainian
...
organizer: *UKR SSTV CONTEST, P. O. Box 10, Kerch, 98300 Ukraine*.
...
To activate repeater send the activation tone of frequency 1750&thinsp;Hz,
when the repeater is activated, it's send &ndash;.&ndash; (K) in morse code.
...
### HF and 50&thinsp;MHz repeater list

,aligncharacter=yes] Freq. Call QTH Activation Power Note 3720 F5ZFJ Haute Sa\^{o}ne, JN27UR image linked with repeater on 144525&thinsp;MHz 14236 VK3DNH Rochester Active 24 hours 14239 VK2ISP Coogee, New South Wales Aktive 24 hours 21349 VK6ET Brackenridge, approx. 20&thinsp;km north from Brisbane 50&ndash;100&thinsp;W QRV 22:00-08:00 UTC 28660 GI4GTY Lisburn image 28688 HB9AC Eighental, Lucerne JN47CA 1750&thinsp;Hz Linked with repeater on 144825&thinsp;MHz FM. 28690 K3ASI North Carolina 1750&thinsp;Hz 45&thinsp;W Aktive 24 hours, beacon every 15-20 minut. 28700 ON4VRB Heist o/d Berg 1750&thinsp;Hz Linked with repeater on 433925&thinsp;MHz. 28750 ON0DTG Doornik 28900 EA8EE 50500 F6IKY Haute Savois (700 m) USB 50510 OZ6STV Copenhagen, JO65ER 1750&thinsp;Hz 60&thinsp;W Beacon every 30 minutes. }

[](8.6_satellites-and-space-broadcast.md ":include")
